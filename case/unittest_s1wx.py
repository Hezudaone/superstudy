...
class S1_wanxue_cn(unittest.TestCase):
    ...
    def test_c_feitongkao_av(self):
        ''' 全国非统考专业课学习 '''
        self.driver.get('https://s1.wanxue.cn/sls/notUnifiedExam/getContent')
    ...
    def test_e_chaojishuk(self):
        ''' 超级书库 '''
        self.driver.get('https://s1.wanxue.cn/sls/superbook/getHtml')
    ...
    def test_f_zonghezixun(self):
        '''综合资讯'''
        self.driver.get('https://s1.wanxue.cn/sls/information/index')
    ...
    def test_h_zhiboke(self):
        '''直播课'''
        self.driver.get('https://s1.wanxue.cn/sls/liveVideoView/queryLivePublicLesson')
...
# 直播课堂---公开课 /html/body/div[11]/div/div[2]/ul/li[7]/a[2]
    ...
    def test_k_xianxia(self):
        '''线下解题'''
        self.driver.get('https://s1.wanxue.cn/sls/category/queryList')
        time.sleep(2)
