...
class Tests_wanxue_cn(unittest.TestCase):

    @classmethod
    def setUpClass(self):
        self.driver = webdriver.Chrome()
        self.driver.get('https://tests.wanxue.cn')
    ...
    def test_a_login(self, user='wx98', password='abc123'):
        '''使用wx98登录'''
        self.driver.find_element_by_xpath('//*[@id="categorylistLogout"]/div[1]/div/ul/li[1]/a').click()
    ...
    def test_b_intellect_study(self):
        ...
        '''智能课程学习'''
        # 进入数学二课程
        self.driver.find_element_by_xpath('/html/body/div[9]/div[3]/div[2]/div[4]/div[6]/div[6]/dl/dd/a').click()

        # 开始学习
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/a').click()
        self.driver.find_element_by_xpath('/html/body/div[5]/div[3]/div[1]/h4[2]').click()  # 进度管控
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div/h4[3]').click()  # 学习报告
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[5]/div[3]/div[1]/h4[4]').click()  # 动态学习规划
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/h4[5]').click()  # 错题通练
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/h4[6]').click()  # 题目收藏夹
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/h4[1]').click()  # 课程学习
        # 阶段选择
        self.jieduan_for()
    ...
    def coures_for(self):
        for x in range(22):
            ...
            # 解析
                ...
                try:
                    # 获取解析标识
                    self.driver.find_element_by_xpath('/html/body/div[4]/div/div[1]/div[2]/ul/li[3]')
                    time.sleep(3)
                    # 下一步
                    self.driver.find_element_by_xpath('//*[@id="nextName"]/span[1]').click()
                    ...
                    # 人工指导
                    self.driver.find_element_by_xpath('//*[@id="nextName"]/span[1]').click()
                    self.driver.find_element_by_xpath('/html/body/div[5]/div/a[1]').click()

    def test_c_feitongkao_av(self):

        '''全国非统考专业课'''
        self.driver.get('https://tests.wanxue.cn/sls/notUnifiedExam/getContent')
        self.driver.find_element_by_xpath('//*[@id="regionName_1"]/div[2]/div[2]/dl/dd/a').click()
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/div/ul[2]/li[3]/a[1]').click()
    ...
    def test_d_liankao(self):
        '''资料中心-联考/非联考'''
        self.driver.get('https://tests.wanxue.cn/sls/nonDownload/queryRegionAll')
        self.driver.find_element_by_xpath('/html/body/div[4]/div[3]/div/div[1]/div[2]/div[1]/a/div/p').click()
        ...
        self.driver.find_element_by_xpath(
            '/html/body/div[4]/div[3]/div/div[2]/div[3]/div/ul/li[8]/ul/li[1]/span[1]').click()
        time.sleep(1)
        self.driver.find_element_by_xpath('//*[@id="projectName"]').send_keys('金融')
        time.sleep(1)
        self.driver.find_element_by_xpath('//*[@id="proName34"]/li[1]/input[2]').click()
        time.sleep(2)
        self.driver.find_element_by_xpath('//*[@id="proName34"]/li[3]/span[1]').click()
        time.sleep(1)
        self.driver.find_element_by_xpath('//*[@id="proName34"]/li[5]/ul/li/a').click()
        ...
        flag = self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/h2').text
    ...
    def test_e_chaojishuk(self):
        ...
        '''超级书库'''
        self.driver.get('https://tests.wanxue.cn/sls/superbook/getHtml')
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/ul/li[3]/a').click()
        self.driver.find_element_by_xpath('//*[@id="yyy"]/div[1]/dl[2]/dd[1]').click()
    ...
    def test_f_zonghezixun(self):
        ...
        '''综合资讯'''
        self.driver.get('https://tests.wanxue.cn/sls/information/index')
    ...
    def test_g_wodekecheng(self):
        ...
        self.driver.find_element_by_xpath('/html/body/div[6]/div/div[2]/ul/li[8]/a[2]').click()
        time.sleep(2)
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath('/html/body/div[9]/div[2]/div/div[2]/ul/li[8]/a[1]').click()
        time.sleep(2)
        self.driver.find_element_by_xpath('//*[@id="pwdPage"]').click()
    ...
    def test_h_zhiboke(self):
        ...
        '''直播课堂'''
        self.driver.get('https://tests.wanxue.cn/sls/liveVideoView/queryLivePublicLesson')
    ...
    def gongkaike(self):
        ...
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/div[1]/a/img').click()
        time.sleep(3)
        self.driver.back()
        time.sleep(2)
        self.driver.find_element_by_xpath('//*[@id="100"]').click()
        time.sleep(1)
        self.driver.find_element_by_xpath('//*[@id="publicUl2"]/li[1]/dl/dd[3]/a').click()
        time.sleep(6)
        all_hand = self.driver.window_handles
        self.driver.switch_to_window(all_hand[1])
        time.sleep(1)
    ...
    def test_i_fudaojuzhen(self):
        ...
        '''专家答疑'''
        self.driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/ul/li[5]/a[2]').click()
        time.sleep(3)
        self.driver.find_element_by_xpath('/html/body/div[5]/div/ul/li[1]/a/img').click()
        self.driver.back()
        time.sleep(1)
        self.driver.find_element_by_xpath('/html/body/div[5]/div/ul/li[2]/a/img').click()
        self.driver.back()

    def test_j_baokaojuece(self):

        '''报考决策'''
        self.driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/ul/li[7]/a[2]').click()
        time.sleep(1)
    ...
    def test_k_xianxia(self):
        ...
        self.driver.get('https://tests.wanxue.cn/sls/category/queryList')
        time.sleep(2)
